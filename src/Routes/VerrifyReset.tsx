    ...
    return (
        <div className="verify_cont ">
            <motion.div
                ...
                <div style={{ fontFamily: "FilsonPro-Medium, sans-serif", letterSpacing: "1px",textAlign:"center" }}>You have successfully created a new password</div>
